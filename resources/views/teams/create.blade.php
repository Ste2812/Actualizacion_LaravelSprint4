...
<div class="m-20">
    <form class="m-20 overflow-auto block p-6 rounded-lg shadow-lg bg-white max-w-md" action="{{route('team.store')}}" method="POST">
        @csrf
        ...
        <label>
            ...
            <textarea class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" type="text"  name="descripcion" id="descripcion" cols="10" rows="5">{{old('descripcion')}}</textarea>
        </label>
        </div>
